...
import com.fabhotels.wallet.exception.AccountNotAssociatedWithWalletException;
import com.fabhotels.wallet.exception.UserAlreadyHasWalletException;
import com.fabhotels.wallet.exception.InsufficientBalanceInWalletException;
...
public class WalletServiceImplTest {
    ...
    public void createWallet()throws Exception{
        ...
        User c = new User();
        c.setUserId(1);
        c.setEmail("sumanpal123");
        c.setFname("Sumanpal");
        c.setLname("Yadav");

        when(userRepoMock.findById(anyInt())).thenReturn(java.util.Optional.ofNullable(c));
    ...
    public void createWallet_CustomerDoesNotExistException()throws Exception{
        ...
        when(userRepoMock.findById(anyInt())).thenReturn(java.util.Optional.ofNullable(null));
        when(walletRepoMock.save((Wallet)anyObject())).thenReturn(w);
     ...
     */
    @Test(expected = UserAlreadyHasWalletException.class)
